        ...
        <div>
            ...
            <div className={`pt-6 flex items-center ${!open ? "border-none" : "border-b border-red-300"}`}>
                <RxDashboard
                    ...
                    <h1 className={`origin-left ml-5 text-lg cursor-pointer ${!open ? "scale-0 duration-300" : "duration-500"}`}>Dashboard</h1>
            </div>

            <div className={`pt-6 flex items-center ${!open ? "border-none" : "border-b border-red-300"}`}>
                <HiOutlineUsers
                    className={`text-xl cursor-pointer min-w-fit`} />
                    <h1 className={`origin-left ml-5 text-lg cursor-pointer ${!open ? "scale-0 duration-300" : "duration-500"}`}>Users</h1>
            </div>

            <div className={`pt-6 flex items-center ${!open ? "border-none" : "border-b border-red-300"}`}>
                <AiOutlineSetting
                    className={`text-xl cursor-pointer min-w-fit`}/>
                    <h1 className={`origin-left ml-5 text-lg cursor-pointer ${!open ? "scale-0 duration-300" : "duration-500"}`}>Settings</h1>
            </div>
            ...
            <div className='pt-6 flex flex-col items-center'>
                ...
                { openMenu && <div className={`pt-4 w-full self-start ${!open && "hidden"}`}>
                    ...
                    <div className='text-lg mt-2  border-b border-red-300 cursor-pointer'>Foster</div>
                </div> }
            </div>
            ...
            <div className='pt-6 flex flex-col items-center'>
                ...
                { openLf && <div className={`pt-4 w-full self-start ${!open && "hidden"}`}>
                    ...
                    <div className='text-lg mt-2  border-b border-red-300 cursor-pointer'>Found Pets</div>
                </div> }
            </div>
            ...
            <div className='flex items-center'>
                <BiLogOut
                className={`text-xl cursor-pointer min-w-fit`} />
                <h1 className={`origin-left ml-5 text-lg cursor-pointer ${!open ? "scale-0 duration-300" : "duration-500"}`}>Logout</h1>
            </div>
    </div>
  )
}
