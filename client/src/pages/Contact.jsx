...
const Contact = () => {
  return (
    <div className=' m-10 px-3 max-h-fit relative'>
        <div className=''>
            
            
            <p className='font-bold text-5xl text-center text-rose-600'>We would love to hear from you.</p>
            ...
            <div className='bg-slate-800 p-4 flex mt-10 flex-row justify-around align-baseline'>
                <div className=' bg-slate-200 mx-3 max-w-md p-2'>
