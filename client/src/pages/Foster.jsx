...
const Foster = () => {
    return (
      <div className='bg-slate-400 my-10 px-8 h-max w-[100vw] relative flex justify-center items-baseline '>
          <section className="w-[40%] h-fit p-5 m-10 bg-primary inline-block relative lg:text-white">
          ...
          <section className="w-[55%] h-fit p-5 m-10 bg-primary inline-block">
              <form className="outline-dashed p-4 relative">
                  ...
                  <textarea name="pet_name" id="" cols="40" rows="2"></textarea>
                  ...
                  <textarea name="pet_name" id="" cols="60" rows="2" placeholder="Sample format: Ana / Mother / 35, Tony / Father / 37, "></textarea>
                  ...
                  <textarea name="pet_name" id="" cols="60" rows="2" placeholder="Cat / Puspin / Rescue / 7yrs / Male / Neutered "></textarea>
                  ...
                  <label className="block font-medium mt-3">If yes, please give us some details about your pets (in the format shown below): *</label>
                  <textarea name="pet_name" id="" cols="60" rows="2"></textarea>
                  ...
                  <input type="radio"/>Basic (check-ups, vaccinations, de-worming)
                  <br />
                  <input type="radio" /> All (Basic + extensive medical procedures such as surgery, chemo, etc.)
                  ...
                  <input type="radio" /> Online search (e.g., Google)
                  <input type="radio" /> Magazine
                  <input type="radio" /> Friend
                  ...
                  <button className="block border border-black p-2 w-20">Submit</button>
              </form>
          </section>
