...
const Tnvr = () => {
  return (
    <div className='bg-slate-400 m-10 p-5 sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto'>
        ...
        <p className='mx-20 my-6'>More than thirty years of documented proof shows that trap-and-kill methods have no lasting effect on reducing feral cat populations. Trap and kill is simply ineffective, expensive and cruel. If all the cats are not caught, then the ones left behind over breed until the former population level is reached.</p>
        <p className='mx-20 my-6'>Even if all the cats are removed, new un-neutered cats move in to take advantage of whatever food source is available. Once there, they breed prolifically, quickly populating a new colony with descendants that are more cautious and more disease-resistant. This “vacuum effect” is very well-documented. Therefore the trap/kill effort becomes increasingly unproductive in the effort to reduce numbers.</p>
        <p className='mx-20 my-6'>Trap/Catch-Neuter-Vaccinate-Return, commonly referred to as “TNVR,” is the only method proven to be humane and effective at controlling the feral cat population. Using this technique, all the feral cats in a colony are trapped, neutered and then returned to their territory.</p>
        <p className='mx-20 my-6'>A feral cat management plan, such as the one promoted by CARA, has a dramatic impact on solving neighborhood feral cat problems.</p>
        <p className='mx-20 my-6'>The Trap/Catch-Neuter-Vaccinate-Return (TNVR) method has shown to be enormously successful in reducing cat populations, at the same time it also offers the cats peaceful lives in their territories. In the end, everyone benefits: cats, wildlife, and people. It is effective, responsible and humane. The breeding stops and populations are gradually reduced. Nuisance behaviors associated with mating and breeding, such as calling and fighting, are virtually eliminated.</p>
        <p className='mx-20 my-6'>TNVR recognizes there is a balance in our urban society, one that includes feral cats. We would be overrun with rats and cockroaches if it wasn’t for the cats. TNVR is a movement that will hopefully continue to grow as more and more people see that it works.</p>

        <h1 className='mx-20 my-6 text-3xl font-medium'>TNVR Program Implementation</h1>
        ...
        <p className='mx-20 my-6'>Here is an example of a healthy well maintained colony; this photo was taken at the Manila Polo Club. These cats are all spayed and neutered and are fed daily by a volunteer. They keep the rodent and roach situation under control and live peacefully alongside their fellow human beings.</p>
        <img src={vilCats} alt="cat trap" className='m-auto'/>
        <p className='mx-20 my-6'>We encourage all villages, clubs and areas to use this humane approach to controlling their cat population. We hope to make this list a lot longer in years to come when people realize, there is a humane way to control the cat population.</p>

        <h1 className='mx-20 my-6 text-3xl font-medium'>Setting UP TNVR in Your Area</h1>
        <p className='mx-20 my-6'>CARA is here to help support and guide you. But we MUST DO IT TOGETHER. To set up a Trap/Catch-Neuter-Vaccinate-Return (TNVR) of stray cats in your community, do the following first.</p>
        ...
        <h1 className='mx-20 my-6 text-3xl font-medium'>How to Set-Up Costs</h1>
