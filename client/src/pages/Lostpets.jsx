...
return(
    <div>
        <Navbar/>
        <div>
            <h1 className='sm:text-3xl md:text-4xl text-2xl font-bold xl:text-6xl text-blue-900 text-center mt-8 md:mt-12 '>Lost And Found</h1>
            <p className='text-sm md:text-l lg:text-xl font-bold xl:text-2xl  text-center'>Reuniting Lost Pets with Their Families </p>
        </div>
        <div className="px-16 md:px-[50px] lg:px-[150px] xl:px-[200px] xl:mt-[80px] mt-[40px]">
          <div className="flex justify-between">
            ...
            <div>
            <Link to="/lostpetsall" className="text-xl md:text-2xl lg:text-lg text-blue-900 font-bold" >See All</Link>
            </div>
