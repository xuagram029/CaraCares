  ...
  return (
    <div className='bg-slate-400 m-10 px-3 max-h-fit relative'>
        ...
        <section className='flex flex-row'>
            <img src={cath} alt="" className='max-w-[400px] max-h-[300px] mt-10 inline-block flex-wrap'/>
            <div className='flex flex-grow flex-wrap flex-col '>
                <div className='p-4 m-3'>
                    <h1 className='text-[30px] font-semibold'>About CARA</h1>
                ...
                <div className='p-4 m-3'>
                    <h3 className='text-[22px] font-semibold mb-2'>Vision</h3>
                ...
                <div className='p-4 m-3'>
                    <h3 className='text-[22px] font-semibold mb-2'>Mission</h3>
        ...
        <section className='flex flex-row'>
            <div className='flex flex-grow flex-wrap flex-col '>
                <div className='p-4 m-3'>
                    <h1 className='text-[20px] font-semibold mb-4' >Goals</h1>
            ...
            <img src={miney} alt="" className='max-w-[300px] max-h-[300px] mt-10 inline-block flex-wrap'/>
        </section>
        {/* note */}
        <section className='flex flex-row'>
            <div className='flex flex-grow flex-wrap flex-col '>
                <div className='p-4 m-3'>
                    <h1 className='text-[20px] font-semibold mb-4' >Please note: </h1>
                    <ul className='list-disc ml-10'>
                ...
                <Link className='underline hover:no-underline mb-4 ml-10'>Learn more about what we do in our FAQs.</Link>
                <Link className='underline hover:no-underline mb-4 ml-10'>Learn more about becoming a CARA volunteer.</Link>
            </div>
        </section>
        {/* new clinic */}
        <section className=''>
            <img src={clinic} alt="" className='max-w-[600px] max-h-[600px] mt-10 m-auto'/>
            <div className=''>
                <div className='p-4 m-3'>
