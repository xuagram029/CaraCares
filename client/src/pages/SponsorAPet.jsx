...
const Sponsor = () => {
  return (
    <div className='bg-primary m-10 p-5 sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto'>
        ...
        <h1 className='mx-20 my-6 text-3xl font-semibold text-center sm:text-center lg:text-left'>How Sponsorship Helps Pets</h1>
        <p className='mx-20 my-4 indent-10 sm:indent-10 lg:indent-0'>Your sponsorship helps towards food, vaccinations, medical care, spaying/neutering and toys for your sponsored friend and allows us to help even more animals.</p>
        <p className='mx-20 my-4 indent-10 sm:indent-10 lg:indent-0'>A lot of the animals in our sponsorship program are long term residents who will probably never be adopted – often due to medical issues, problems socializing with people, or they just simply haven’t found that special owner yet. Older animals have such a hard time finding homes.</p>
        <p className='mx-20 my-'>In exchange for sponsoring one of our furry friends, we will:</p>
        <ul className='list-disc mx-32 my-4'>
        ...
        <div className=' p-10 flex flex-col justify-center items-center gap-5'>
            <div className='flex gap-5 lg:flex-row md:flex-row sm:flex-wrap sm:justify-center'>
                ...
                <button class=" bg-slate-500 hover:bg-neutral-900 hover: text-white font-bold py-2 px-8 rounded-lg mx-auto">Donate via Pet Warehouse</button>
            </div>
        </div>
    </div>
  )
