...
const ShelterSignup = () => {
    ...
    return (
      ...
      style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1553688738-a278b9f063e0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80')`,
      }}
    >
      <div
      ...
      <div className="relative ">
        ...
        <p className="text-white text-center text-sm p-6 leading-6">
          We're thrilled that you're interested in joining our compassionate community. Create your account by providing
          a few details below. Together, we can make a positive impact on the lives of our furry friends.
        </p>
        ...
        <div className="flex justify-center items-center m-10">
          ...
          <button className="inline-block bg-green-600 px-8 py-2 text-sm font-medium rounded-xl mx-auto border-4 border-white hover:bg-white hover:text-green-600 text-white">
            <Link to="/shelter-login">Sign in</Link>
          </button>
        </div>
      </div>
    </div>
