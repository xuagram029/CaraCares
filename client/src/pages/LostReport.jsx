...
function LostReport(){
    ...
    const handleSubmit = async(e) =>{
        await axios.post('http://localhost:8000/lostpet', {name, phone:phonenumber, email, typeofpet, gender:petgender, color, breed, lost:dateoflost , description})
        navigate('/')
      }
    return(
        <div>
                ...
                <div className="gap-2">
                 ...
                 <div className="grid grid-cols-3 gap-2 mt-2 mb-6">
                    ...
                    <div >
                        ...
                        <textarea className="border-2 border-solid w-full p-4" cols="30" rows="5"
