...
const handleClick = async (e) => {
    ...
    try {
        const res = await axios.post("https://caracares.onrender.com/user/login", credentials)
  ...
  <section class="flex flex-col md:flex-col lg:flex-row w-3/4 h-[500px] mx-auto my-24 justify-center ">
    <div class=" bg-white rounded-l-2xl p-12 shadow-3xl">
      <div class="mx-auto max-w-lg text-center">
        <h1 class="text-2xl font-bold sm:text-3xl text-green-500">Welcome Back User!</h1>
        <p class="mt-4 text-gray-900">
        We're excited to have you continue your journey with us. 
        </p>
      </div>
    ...
    <div class=" bg-green-600 w-1/4 rounded-r-lg shadow-xl flex items-center justify-center">
        <div class="">
          ...
          <div class="flex justify-center m-10">
          <button 
            class="inline-block bg-green-600 px-8 py-2 text-sm font-medium rounded-xl mx-auto border-4 border-white hover:bg-white hover:text-green-600 text-white"><Link to='/user-signup'>Sign up</Link></button>
        </div>
        </div>
    </div>
