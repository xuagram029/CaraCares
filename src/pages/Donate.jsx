...
const Donate = () => {
  return (
      <div className='bg-slate-400 m-10 px-3 max-h-fit relative overflow-auto'>
        ...
        <div className='flex flex-col sm:flex-col sm:justify-center sm:items-center md:flex-row xl:flex-row bg-slate-800 p-10 gap-6 items-center'>
            <div className='bg-slate-300 sm:w-[350px] md:w-1/2'>
        ...
        <div className='p-20 flex bg-slate-500 my-5 gap-10 justify-between flex-col sm:flex-col lg:flex-row'>
        ...
        <div className='p-20 flex flex-col bg-slate-500 my-5 justify-between sm:flex-col md:flex-row lg:flex-row gap-4 '>
        ...
        <div className='flex flex-col sm:flex-row justify-center items-center bg-slate-800 py-5 px-4 gap-4 my-5 sm:text-center'>
        ...
        <div className='flex flex-col sm:flex-row justify-center items-center bg-slate-200 py-5 px-4 my-5 gap-10 sm:px-4 md:px-12'>
            <div className=' bg-slate-300  max-h-74 flex flex-col gap-6 leading-4 p-10 sm:p-10 md:p-14'>
                <p>OBM Dry Food</p>
            ...
            <div className=' bg-slate-300 p-14 max-h-74 flex flex-col gap-6 leading-4'>
            ...
            <div className='text-center text-3xl font-semibold bg-slate-300 p-5 mb-3'>
